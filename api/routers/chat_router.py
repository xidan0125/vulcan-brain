...
from core.tools import get_tool_names, get_tool_schemas
...
CPU_BASE_URL = "http://localhost:8002/v1"
...
async def health_check():
    ...
    try:
        async with httpx.AsyncClient(timeout=5.0) as http:
            resp = await http.get(f"{CPU_BASE_URL}/models")
