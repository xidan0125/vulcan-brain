...
| 任务 | 工具 | 产出 |
|------|------|------|
| 1.1 邮件Embedding | text-embedding-3-small | 向量化10K+邮件 |
...
| 任务 | 工具 | 产出 |
|------|------|------|
| 2.1 零样本NER | GLiNER | 人名/公司/项目/金额 |
| 2.2 邮件分类 | LLM few-shot | 销售/采购/HR/内部等 |
| 2.3 实体消歧 | 规则 + Embedding | 合并SpaceX/Space X |
